...
public class IssuerController {
    ...
    @Operation(summary = "Get all base bonds issued by the issuer", description = "Retrieve all base bonds issued by the issuer")
    ...
    @Operation(summary = "Get all hired bonds issued by the issuer", description = "Retrieve all hired bonds issued by the issuer")
